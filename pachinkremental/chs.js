...
//    测试版
    ...
    'OD Lunatic Red Eyes': '过载疯狂的红眼',
    'OD Rainbow UFO': '过载彩虹飞碟',
    'OD Perfect Freeze': '过载完美冻结',
    'OD Midas': '过载大富翁',
    'OD Accelerator': '过载加速器',
    'OD Green-Eyed Monster': '过载绿眼怪物',
    'Overdrive': '过载',
    ...
    "Hits by Beach Balls during Overdrive increase both their individual combo and the Hyper Combo by 2 instead of 1.": "在 过载 期间被沙滩球击中会使它们的个人组合和 超级组合 增加 2 而不是 1。",
    "Allows Spiral Power to exceed 100%, with diminishing returns above 100%.": "允许螺旋能量超过 100%，收益递减超过 100%。",
    "Each individual Spiral Ball increases in value based on how much Spiral Power it has generated. (Stacks multiplicatively with gemstone ball multipliers.": "每个单独的螺旋球的价值会根据它产生的螺旋能量增加。 （与宝石球乘数相乘叠加。",
    "Increases the probability of dropping Spiral balls.": "增加掉落螺旋球的概率。",
    "During Overdrive, the 3 gemstone ball multipliers stack multiplicatively instead of additively.": "在 过载 期间，3 个宝石球倍增器以乘法而不是相加方式叠加。",
    "2× Emerald Ball Value during Overdrive.": "过载 期间 2 倍翡翠球价值。",
    "2× Sapphire Ball Value during Overdrive.": "过载 期间 2 倍蓝宝石球价值。",
    "2× Ruby Ball Value during Overdrive.": "过载 期间 2 倍红宝石球价值。",
    "Spiral Power drains slower during Overdrive.": "过载期间，螺旋能量消耗较慢。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " base Hyper Multiplier during Overdrive.": "过载期间的基础超级乘数。",
    " Rubber Band Ball Value during Overdrive.": "过载期间的橡皮筋球值。",
    "": "",
    "": "",
    "": "",
    "": "",
